...
const AuthenticationcreateUser = async function (hum, tum) {
  let userdata = hum.body;
  let saveddata = await userModel.create(userdata);
  console.log(hum.newAttribute);
  tum.send({ message: saveddata });
};
//----------------login users---------------------------------------------------------
const loginUser = async function (req, res) {
  ...
  if (!User)
    return res.send({
      status: false,
      msg: "UseremailId or the password is not corerct Please check your UseremailId nad password",
    });
...
module.exports.AuthenticationcreateUser = AuthenticationcreateUser;
